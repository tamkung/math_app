                                    ...
                                    return Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        onTap: () async {
                                          ...
                                          _user_answers.removeWhere((element) =>
                                              element.keys.first == txt_id);
                                          _user_answers.add({
                                            txt_id: index + 1,
                                          });
                                          ...
                                          if (activeStep < _items.length - 1) {
                                            ...
                                            _user_answers.sort((a, b) => a
                                                .keys.first
                                                .compareTo(b.keys.first));
                                            _correct_answers.sort((a, b) => a
                                                .keys.first
                                                .compareTo(b.keys.first));
                                            // คำนวณคะแนน
                                            for (int i = 0;
                                                i < _user_answers.length;
                                                i++) {
                                              var userAnswer = _user_answers[i];
                                              var correctAnswer =
                                                  _correct_answers[i];

                                              print(userAnswer.values.first);
                                              print(correctAnswer.values.first);

                                              // แปลงชนิดข้อมูลของ userAnswer เป็นสตริง
                                              var userAnswerString = userAnswer
                                                  .values.first
                                                  .toString();
